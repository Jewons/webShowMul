 ...
 * 包含“道路切换、浪涌”两个视图
 */
function highstockView_bz01() {
	// create the chart
	$('#bandAdaptive_main1_bz01').highcharts('StockChart', {
				title : {
				...
				tooltip : {// 标签提示框
					...
					formatter : function() {
						...
						if(this.y==1){
	                		...
	                		return "道路切换，"+switchinfoMap.get(splitTime(time).getTime()+"_1_bz");
	                	}else if(this.y==2){
	                		return "浪涌，"+switchinfoMap.get(splitTime(time).getTime()+"_2_bz");
	                	}else{
							return "未获取此时间点的相关数据";
						}
					},
